...
O Ubuntu pode usar o mesmo método do Debian para configuração de interface do tio bridge, no entanto, é preferivel usar o método considerado mais moderno,  uma framework(conjunto de comandos)  chamado de **Network Manager** para fazer este ajuste.
