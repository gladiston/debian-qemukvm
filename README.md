...
Se possível, todas as partições que contêm dados importantes devem ter um *label* como #dados1, #dados2, #disco1, #home e assim por diante, sempre fáceis de identificar com **lsblk -f**. Colocar labels em disco é vida!  
...
[Criando conexões bridge do tipo ponte](debian_qemu_kvm_bridge_ponte.md)     
...
## Criando e anexando discos extras (QCOW2)

Quando precisar de mais espaço, um volume separado para dados, ou quiser anexar discos adicionais por VM (ao invés de aumentar o disco principal), siga o guia abaixo:

[Criando e anexando discos extras](debian_qemu_kvm_disco_extra.md)
