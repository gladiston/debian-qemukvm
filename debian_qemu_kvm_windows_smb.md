...
Esse método é rápido e veloz, mas apresenta alguns problemas conhecidos:

1. **Delphi**: Por alguma razão desconhecida, mesmo eu vendo os arquivos e podendo editá-los, a IDE do Delphi insiste em dizer que certos arquivos não foram encontrados.
